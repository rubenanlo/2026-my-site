...
export default function BubbleWords({
  ...
  }, [screenSize, skillsData, onOverflowChange]);
    ...
    <AnimatePresence>
      {isInView && (
        <div
          ref={containerRef}
          className={clsx(
            "relative flex items-center justify-center flex-3 h-[300px] sm:h-[500px] lg:h-[900px] mx-auto rounded-full px-4 sm:px-6 lg:px-8 overflow-hidden select-none",
        ...
        >
          {skillsData.map((skill, index) => {
            ...
            const zIndex = Math.floor(skill.importance * 4); // Higher importance = higher z-index for visibility
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  top: `calc(60% + ${position.y + panOffset.y}px)`,
